...
using MoviesHome.Models.TokenAuth;
...
{
    public abstract class MoviesHomeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MoviesHomeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MoviesHomeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MoviesHomeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MoviesHomeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MoviesHomeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MoviesHomeDbContext, Task<T>> func)
        {
            T result;
